...
```{r}
allPeaks_annotation.df <- cbind(as.data.frame(allPeaks@seqnames),
                                as.data.frame(allPeaks@ranges),
                                as.data.frame(allPeaks@elementMetadata@listData))
colnames(allPeaks_annotation.df)[1] <- "seqnames"

rownames(allPeaks_annotation.df) <- paste(allPeaks_annotation.df$seqnames,
                                          allPeaks_annotation.df$start,
                                          allPeaks_annotation.df$end, sep="_")
```
